    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w6xl mx-auto px-4 sm:px-6">
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          ...
          <div className="mx-sm grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-8 md:gap-y-8 lg:grid-cols-5">
            <article className="flex align-items justify-content ">
              <svg
                className="mb-3 mr-4 fill-teal-500"
